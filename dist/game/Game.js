...
export class Game {
    ...
    renderStaticAssets() {
        ...
        this.castleNode.replaceChildren(this.createAssetImage(level.castleSkin, "castle-sprite", "Blue castle", "🏰", () => {
            this.castleNode.classList.add("asset-loaded");
        }), this.createTextNode("div", "castle-flag", "⚑"), this.createTextNode("div", "castle-label", "Castle"));
    ...
    createAssetImage(assetKey, className, alt, fallbackText, onLoad) {
