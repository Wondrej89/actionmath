...
export class Game {
  ...
  private renderStaticAssets(): void {
    ...
    this.castleNode.classList.remove("asset-loaded");
    this.defenseTowerNode.classList.remove("asset-loaded");
    this.castleNode.replaceChildren(
      this.createAssetImage(level.castleSkin, "castle-sprite", "Blue castle", "🏰", () => {
    ...
    this.defenseTowerNode.replaceChildren(
      this.createAssetImage("tower_blue", "tower-sprite", "Blue defense tower", "🧙‍♂️", () => {
